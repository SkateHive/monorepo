...
cd "$MONOREPO_ROOT/services/skatehive-video-transcoder" && docker-compose up -d
cd "$MONOREPO_ROOT/services/skatehive-instagram-downloader/ytipfs-worker" && docker-compose up -d
